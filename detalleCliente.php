<<<<<<< HEAD
    ...
    $query4 = mysqli_query($conn, "SELECT sum(LOAN_AMOUNT) FROM  loans WHERE CUSTOMER_ID = $customers_id");

    $query5 = mysqli_query($conn, "SELECT * FROM  loans WHERE CUSTOMER_ID = $customers_id");

    $query6 = mysqli_query($conn, "SELECT * FROM  customers WHERE ID_NUMBER = $clienteId");

    $query7 = mysqli_query($conn, "SELECT sum(PAYMENT_AMOUNT) FROM  payments WHERE CUSTOMER_ID = $customers_id");
    ...
    $query15 = mysqli_query($conn, "SELECT count(*) FROM  amortization ");

    $query16 = mysqli_query($conn, "SELECT  AVG(LATE_DAYS) FROM  amortization WHERE CUSTOMER_ID = $customers_id");

    $query17 = mysqli_query($conn, "SELECT  * FROM  amortization WHERE CUSTOMER_ID = $customers_id");

    $query18 = mysqli_query($conn, "SELECT  * FROM  amortization WHERE CUSTOMER_ID = $customers_id");

    $query19 = mysqli_query($conn, "SELECT sum(LOAN_AMOUNT) FROM  loans WHERE CUSTOMER_ID = $customers_id");

    $query20 = mysqli_query($conn, "SELECT sum(CUOTA) FROM  amortization WHERE CUSTOMER_ID = $customers_id");

    $query21 = mysqli_query($conn, "SELECT  sum(AMORTIZACION_PAGADA)FROM  amortization WHERE CUSTOMER_ID = $customers_id");
    ...
    INNER JOIN loans AS loans ON customers.CUSTOMER_ID = loans.CUSTOMER_ID WHERE customers.CUSTOMER_ID = $customers_id");
...
?>
    ...
    <thead class= "thead-dark">
              ...
              <tr>
                  ...
                  <td><?php echo number_format($datos['MONTO_CUOTA_TOTAL'],2)?></td>
                  <td><?php echo number_format($datos['MONTO_SOLO_INTERESES'],2)?></td> 
                  <td><?php echo number_format( $datos['MONTO_CUOTA_TOTAL']-$datos['MONTO_SOLO_INTERESES'],2)?></td>                  
                  <td><?php echo $datos['USER_CLIENTE_ID']?></td>
                  
                  <td><?php    echo $diaMayor?>
        ...
        $lateAmount1 = 0;
        while($payDateAmounts1 = mysqli_fetch_array($query23)){
...
<?php } ?>
    ...
    <div class="card col-12" style="width:100%;">
        ...
        <form method=post action="">
          <textarea  type="text-box" method="POST" class="commentInput"  id="commentInputCliente" name="commentInputCliente" style="width:100%; height:75px;"></textarea>
          <button type="submit" class="btn btn-primary" name="agregar_comentarioCliente" id="agregar_comentarioCliente">Agregar Comentario</button>         
        </div>
      </div><br>
     </form>
     <?php  
